...
export const dataProvider = localStorageDataProvider({
  ...
  defaultData: {
    ...
    projects: [
      {id: 1, title: 'Project 1', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam lectus. Sed sit amet ipsum mauris.', startdate: '2023-11-23', enddate: '2023-12-24', project_leader: 1, project_members: [1, 2, 3]},
    ],
    tasks: [
